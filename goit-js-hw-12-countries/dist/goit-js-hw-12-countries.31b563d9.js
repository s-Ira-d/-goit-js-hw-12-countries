...
input.addEventListener("input", (0, _lodashDebounceDefault.default)(onInput, 500));
function onInput(e) {
    ...
    (0, _fetchCountriesDefault.default)(query).then((countries)=>{
        countryList.innerHTML = "";
        countryInfo.innerHTML = "";
...
function renderCountryList(countries) {
    const markup = countries.map((country)=>`<li>
...
function renderCountryInfo(country) {
    ...
    <p>\u{421}\u{442}\u{43E}\u{43B}\u{438}\u{446}\u{44F}: ${country.capital}</p>
    <p>\u{41D}\u{430}\u{441}\u{435}\u{43B}\u{435}\u{43D}\u{43D}\u{44F}: ${country.population}</p>
    <p>\u{41C}\u{43E}\u{432}\u{438}: ${country.languages.map((lang)=>lang.name).join(", ")}</p>
  `;
}

},{"lodash.debounce":"irvaP","./fetchCountries":"bCGdT","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirec490", {})
